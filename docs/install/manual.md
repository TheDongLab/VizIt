...
**Visit the page at http://<backend-running-ip>:8000. You should see "Welcome to VizIt" on the page.**

## 4. Setup frontend
!!! warning "Important Note"
    Before run this step, please make sure that you have already prepared your `home page folder` and updated the `env/.env` file. 
    You can follow the instructions in the [Customize Home Page](../development/customize_home.md) page to prepare your home page folder and update the env/.env file.
